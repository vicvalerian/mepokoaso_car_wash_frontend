    ...
    <v-main class="list">
        ...
        <v-card>
            <v-card-title>
                ...
                <v-flex xs3>
                    <v-select class="mr-4" label="Jenis Kendaraan" :items="jenis_kendaraan_list" v-model="filter.search" single-line hide-details clearable></v-select>
                </v-flex>
                <v-flex xs3>
                    ...
                    <v-container fluid>
                        <v-layout justify-center>
                            <v-flex xs12>
                                <div class="row">
                                    <div class="mr-8">
                                        <v-img width="300px" :src="previewImgLogo == '' ? $baseUrl+'/storage/'+formDetail.foto : previewImgLogo" style="object-fit:cover;"></v-img>
                                    </div>
                                    <div>
...
export default {
    ...
    methods: {
        ...
        detailHandler(item){
            ...
            this.formDetail.harga = "Rp"+item.harga
